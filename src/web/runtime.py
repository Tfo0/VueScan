...
class WebRuntimeBuildDeps:
    ...
    run_auto_llm_analyze: Callable[[str], dict[str, Any]] | None
    extract_response_params: Callable[[str], dict[str, Any]] | None
...
def build_web_runtime_bundle(deps: WebRuntimeBuildDeps) -> WebRuntimeBundle:
    return WebRuntimeBundle(
        ...
        run_module2_project_sync_background=partial(
            ...
            run_auto_llm_analyze=deps.run_auto_llm_analyze,
            extract_response_params=deps.extract_response_params,
        ),
