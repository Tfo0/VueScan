...
def build_vue_api_route_bundle(deps: VueApiRouteBundleDeps) -> VueApiRouteBundle:
    api_routes = build_vue_api_routes(
        VueApiRouteDeps(
            ...
            run_api_llm_analyze=deps.run_api_llm_analyze,
            save_llm_analysis_result=deps.save_llm_analysis_result,
            load_llm_analysis_result=deps.load_llm_analysis_result,
            start_llm_analyze_job=deps.start_llm_analyze_job,
